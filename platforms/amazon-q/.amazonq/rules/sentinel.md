...
Sentinel is a universal AI agent security scanner for Amazon Q Developer and orchestrates six specialist reviewers:

- sentinel-blue-hat.md
- sentinel-green-hat.md
- sentinel-purple-hat.md
- sentinel-red-hat.md
- sentinel-white-hat.md
- sentinel-yellow-hat.md
