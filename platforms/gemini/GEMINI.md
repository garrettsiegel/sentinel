...
Sentinel is a universal AI agent security scanner for Gemini CLI and orchestrates six specialist reviewers.

Keep these imports in this GEMINI.md file so Gemini can load specialists on demand:
